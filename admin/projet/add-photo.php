  ...
  <div class="content-wrapper" >
    ...
    <section class="content container-fluid">
      ...
      <div class="box-body box-profile">
         <?php
            $_SESSION['id_projet']=$_GET['projet'];
            $projet=Query::affiche('projet',$_GET['projet'],'id');

            if(!$projet){
              Fonctions::set_flash("Ce projet n'existe pas",'danger');
            ...
            <div class="col-md-10">
                ...
                <div class="box box-widget">
                  ...
                  <div class="box-body">
                    ...
                    <p class="col-md-12"><?= $projet->presentation; ?></p>
                  </div>
                  <!-- /.box-body -->
                </div>
                <!-- /.box -->
               ...
               <div class="info-box">
                 ...
                 <a href="?page=Projet&projet=<?= $_GET['projet']; ?>">
...
$(document).ready(function(){
  ...
  $('.crop_image').click(function(event){
    $image_crop.croppie('result', {
      ...
      $.ajax({
        url:"projet/upload/projet.php",
        type: "POST",
        data:{"image": response},
        success:function(data)
        {
          $('#uploadimageModal').modal('hide');
          window.location.href="?page=Projet&projet=<?= $_GET['projet'] ?>";
