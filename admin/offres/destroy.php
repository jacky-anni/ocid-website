<div id="<?= $offres->id;?>" class="modal fade" tabindex="-1" >
	<center>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<center>
					...
					<h5 class="smaller lighter blue no-margin"><b> Supprimer cet offre ?</b></h5>
					<input type="hidden" name="id" value="<?= $offres->id ?>">
				</center>
			</div>
	...
	<?php
		...
		if (isset($_POST['supprimer'])) {
			...
			//delete artile
			Query::supprimer('offres',$_POST['id']);

			Fonctions::set_flash("Offre supprimé","success");
