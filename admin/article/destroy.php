<div id="<?= $article->id;?>" class="modal fade" tabindex="-1" >
	<center>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<center>
					...
					<h5 class="smaller lighter blue no-margin"><b> Supprimer cet article ?</b></h5>
	...
	<?php
		...
		if (isset($_POST['supprimer'])) {
			...
			//delete artile
			Query::supprimer('article',$_POST['id']);
			...
			// Query::supprimer_fichier('photo','photo/server/uploads/', $article->id);

			Query::supprimer_fichier_many('photo','reference',$article->id,'dist/img/photos/');
			...
			Fonctions::set_flash("Article supprimé avec succès","success");
