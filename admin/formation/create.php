                    ...
                    <form action="#" method="post" role="form" data-parsley-validate action="">
                      ...
                      <div class="col-md-6">
                       ...
                       <div class="col-md-12"></br>
                        ...
                        <div class="form-group">
                          <input type="text" class="form-control" value="<?php if(isset($_POST['intervenant']))echo $_POST['intervenant']; ?>" data-parsley-maxlength="230" name="intervenant" placeholder="Jacky Anizaire, Doudou Abdonel, Rico Cheristin" required="">
                        </div>
