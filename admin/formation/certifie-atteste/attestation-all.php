    ...
    <section class="">
      <div class="box-body box-prfofile">
             ...
             <?php
              ...
              <div class="info-box bg-green">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number" style="font-size: 12px; font-weight: normal; color:yellow;">Liste des participants attestés</span>
                  </div>
              <!-- /.info-box-content -->
            </div>
          ...
          <?php include('partials/bouton.php'); ?>
            ...
            <div class="box-header">
            <a href="?page=participants-attestes.&id=<?= $formation->id ?>" target="_blank">
