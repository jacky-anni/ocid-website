<div id="<?= $quiz->id ?>200" class="modal fade" tabindex="-1" >
	<center>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<center>
					...
					<h5 class="smaller lighter blue no-margin"><b> Supprimer ce quiz ?</b></h5>
	...
	<?php
		...
		if (isset($_POST['supprimer'])) {
			Query::supprimer('quiz',$_POST['id']);
			Fonctions::set_flash("Quiz supprimé","success");
