          ...
          <div class="box-body">
             ...
             <div class="info-box bg-green">
              ...
              <!-- /.info-box-content -->
                 ...
                 <a href="?page=statistique-formation&formations=<?= $formations->id; ?>"> <button  class="btn btn-primary " style="margin: 10px;"><span class="fa fa-bar-chart"></span> Statistiques</button></a>
