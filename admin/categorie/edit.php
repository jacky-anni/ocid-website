  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><b> <i class="fa fa-edit"></i> Modifier cette catégorie</b></h4>
      </div>
      <form action="" method="POST" role="form" data-parsley-validate action="">
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" value="<?= $categorie->nom_categorie ?>" name="nom" id="exampleInputEmail1" maxlength="240"  placeholder="Le titre ici..." required="">
          </div>

          <div class="form-group">
            <label for="exampleInputEmail1">Description</label>
            <textarea class="form-control" name="description"  maxlength="240"   placeholder="" rows='6' required=""><?= $categorie->description_categorie ?></textarea> 
          </div>
...
<?php
  if (isset($_POST['modifier'])) {
      ...
      $categorie->modifier($id_categorie);
