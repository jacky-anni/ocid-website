<div id="<?= $categorie->id;?>1" class="modal fade" tabindex="-1" >
	<center>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<center>
					...
					<h5 class="smaller lighter blue no-margin"><b> Supprimer cette catégorie?</b></h5>
	...
	<?php
		...
		if (isset($_POST['supprimer'])) {
			Query::supprimer('categorie',$_POST['id']);
			Fonctions::set_flash("Catégorie supprimée avec succès","success");
