		...
		<?php include('admin/includes/flash.php'); ?>
			<div class="row">
				...
				<div class="col-md-12 c-padding-20" style="border: 1px solid silver;">
					<h3 class="c-font-bold c-font-uppercase c-font-24 alert alert-primary" style="color: #26a8b4; text-align: center;">Kesyon pou entwodiksyon fòmasyon an</h3>

					<?php $test_count=Query::count_prepare('sondage',$_SESSION['id_user'],'id_participant');?>
					<?php if($test_count): ?>
						<center>
		    		...
		    		<?php
		    			if(isset($_POST['valider'])){
		    				...
		    				Quiz::sondage($_SESSION['id_user'],$sexe,$gwoup,$mwayen,$enterese,$kondisyon,$vote,$rezon_vote,$sitiyasyon,$rezon_sitiyasyon_vote);
		    			}
		    		?>
	    			...
	    			<div class="col-md-12 row c-border-top">
	    				<div class="form-group">
							<label  class="col-md-12 control-label"><b>3. Pa ki mwayen ou te enfòme de fòmasyon an :  </b> </label>
						   	<div class="col-md-12">
						  		<div class="radio" style="font-size: 13px;">
								  <label>
								    <input type="radio" name="mwayen" value="Radyo/televizyon" <?php if(isset($_POST['mwayen']) AND $_POST['mwayen']=='Radyo/televizyon'){echo "checked";} ?> id="optionsRadios1" required="">
								    Radyo/televizyon
								  </label>
								</div>
								...
								<div class="radio">
								  <label>
								    <input type="radio" name="mwayen" value="WhatsApp" <?php if(isset($_POST['mwayen']) AND $_POST['mwayen']=='WhatsApp'){echo "checked";} ?> id="optionsRadios1" required="">
								    WhatsApp
								  </label>
								</div>
								...
								<div class="radio">
								  <label>
								    <input type="radio" name="mwayen" value="Facebook /sit wèb" <?php if(isset($_POST['mwayen']) AND $_POST['mwayen']=='Facebook /sit wèb'){echo "checked";} ?> id="optionsRadios1" required="">
								    Facebook /sit wèb
								  </label>
								</div>
								...
								<div class="radio">
								  <label>
								    <input type="radio" name="mwayen" value="Yon zanmi / kòlèg" <?php if(isset($_POST['mwayen']) AND $_POST['mwayen']=='Yon zanmi / kòlèg'){echo "checked";} ?> id="optionsRadios1" required="">
								    Yon zanmi / kòlèg 
								  </label>
								</div>
						    </div>
