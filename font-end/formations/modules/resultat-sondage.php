				...
				<div class="c-content-ver-nav">
					<div class="row">
						<div class="col-md-12">
							<div class="c-content-ver-nav">
								<ul class="c-menu">
									<li><a href="<?= $link_menu ?>/resultat-sondage/<?= $url[1] ?>/enfomasyon-jeneral"><b>1. Enfomasyon jeneral</b></a></li>
									<li><a href="<?= $link_menu ?>/resultat-sondage/<?= $url[1] ?>/question-3"><b>2. Pa ki mwayen ou te enfòme de fòmasyon an</b></a></li>
									<li><a href="<?= $link_menu ?>/resultat-sondage/<?= $url[1] ?>/question-4"><b>3. Jiska ki pwen ou enterese nan zafè politik peyi a pou moman sa?</b></a></li>
									<li><a href="<?= $link_menu ?>/resultat-sondage/<?= $url[1] ?>/question-5"><b>4. Si tout kondisyon te reyini jodia pou peyi a òganize eleksyon pou Senatè ak Depite, èske w t ap deside al vote?</b></a></li>
									<li><a href="<?= $link_menu ?>/resultat-sondage/<?= $url[1] ?>/question-6"><b>5. Si repons ou se « non », ki rezon pèsonèl ki fè ou pa t ap al vote?</b></a></li>
									<li><a href="<?= $link_menu ?>/resultat-sondage/<?= $url[1] ?>/question-7"><b>6. Ki lòt sitiyasyon ki ta fè ou pa t ap al vote, menmsi tout kondisyon te reyini jodia pou peyi a òganize eleksyon pou Senatè ak Depite</b></a></li>
								</ul>
							</div>
						</div>
					</div>
							...
							<tbody style="font-weight: normal;">
								...
								<tr>
									...
									<!-- <?php 
										...
										if($value_zero<0){echo "0";}else{echo $value_zero;}
									 ?> -->
