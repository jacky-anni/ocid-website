	...
	<div class="c-layout-sidebar-content ">
		...
		<div class="row c-margin-t-25">
			...
			<div class="col-md-4 c-margin-b-20 c-margin-t-10">
				...
				<img src="<?= $link_admin ?>/dist/img/user/participant/<?= Fonctions::user()->photo ?>" class="img-responsive img-circle" style="width: 160px;" >
				<h4 class="c-font-uppercase c-font-bold"><?= Fonctions::user()->prenom ?>  <?= Fonctions::user()->nom ?></h4>

				<!-- 	The following addresses will be used on the checkout page by default. -->
                  <p class="list-group-item" style="background-color: #ecfefb;">
                  	<label style="font-size: 15px;">Changer la photo ?</label>
                  	<input type="file" class="btn btn-primary" name="upload_image" accept="image/*" id="upload_image" class=" btn-block col-md-12" style="width: 200px;" />
							...
							<form action="" method="post" role="form" data-parsley-validate action="">
									...
									<div class="col-md-12">
										<div class="row">
											<div class="form-group col-md-6">
												...
												<input type="text" name="nom" value="<?= $user->nom ?>" class="form-control" <?php if(!isset($url[1])){echo "disabled";} ?> placeholder="Ex : Anizaire" required="">
											</div>
											<div class="col-md-6">
												<label class="">Prénom</label>
												<input type="text" name="prenom" <?php if(!isset($url[1])){echo "disabled";} ?> value="<?= $user->prenom ?>" class="form-control" placeholder="Ex : Jacky" required="">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-md-12">
										<div class="row">
											<div class="form-group col-md-6">
												...
												<input type="text" name="lieu_naissance" value="<?= $user->lieu_naissance ?>" class="form-control" <?php if(!isset($url[1])){echo "disabled";} ?> placeholder="Ex : Port-Margot" required="">
											</div>
											<div class="col-md-6">
												<label class="">Département</label>
												<select name="departement" class="form-control" <?php if(!isset($url[1])){echo "disabled";} ?> required="">
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<input type="text" name="commune" <?php if(!isset($url[1])){echo "disabled";} ?> value="<?= $user->commune ?>" class="form-control" placeholder="Ex : Port-Margot" required="">
									</div>
									<div class="col-md-6">
										<label class="">Niveau d'étude</label>
										<select name="niveau" <?php if(!isset($url[1])){echo "disabled";} ?> class="form-control" required="">
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<input type="text" name="universite"  class="form-control" placeholder="Ex: Université Antenor Firmin (UNAF)" <?php if(!isset($url[1])){echo "disabled";} ?> value="<?= $user->universite ?>" />
									</div>

									<div class="form-group col-md-6">
										<label class="control-label">Domaine d'étude </label>
										<input type="text" name="domaine"  class="form-control" placeholder="Ex: Sciences Informatiques" <?php if(!isset($url[1])){echo "disabled";} ?> value="<?= $user->domaine_etude ?>" />
									</div>

									<div class="form-group col-md-6">
										<label class="control-label">Membre d’une association  </label>
										<input type="text" name="organisation"  class="form-control" placeholder="Ex: Sciences Informatiques" <?php if(!isset($url[1])){echo "disabled";} ?> value="<?= $user->organisation?>" >
									</div>

									<div class="form-group col-md-6">
										<label class="control-label">Membre d’un parti politique  </label>
										<input type="text" name="parti"  class="form-control" placeholder="Ex: Sciences Informatiques" <?php if(!isset($url[1])){echo "disabled";} ?> value="<?= $user->parti ?>">
									</div>

									<div class="form-group col-md-6">
										<label>Occupation  </label>
										<input type="text" name="occupation" class="form-control" placeholder="Ex: Sciences Informatiques" <?php if(!isset($url[1])){echo "disabled";} ?> value="<?= $user->occupation ?>">
									</div>

										<div class="form-group col-md-6">
											<label class="">Numéro WhatsApp </label>
											<input type="text" name="numero" <?php if(!isset($url[1])){echo "disabled";} ?>  class="form-control" placeholder="Ex: +5094872-9922" value="<?= $user->numero_what ?>" >
										</div>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<?php }else{?>
										<a href="<?= $link_menu ?>/profile/edit">
											<button type="button" name="modifier" class="btn btn-lg c-theme-btn c-btn-uppercase c-btn-bold btn-sm"> <i class="fa fa-edit"></i> <b>Modifier votre profile</b></button>
										</a>
										<?php  }?>
									</div>
								</div>
