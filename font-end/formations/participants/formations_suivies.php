		...
		<div class="item">
				<div class="c-content-blog-post-card-1 c-option-2">		
					...
					<div class="c-body">
						...
						<div class="c-panel">							
						<div class="c-comments"><a href="#"><i class="icon-speech"></i> <?= $module_passe ?>/<?= $module_total ?> <?php if ($module_total > 1) {
																																																																																																																echo "Modules";
																																																																																																															} else {
																																																																																																																echo "Module";
																																																																																																															} ?></a></div>
		...
		<div class="item">
				<div class="c-content-blog-post-card-1 c-option-2">		
					...
					<div class="c-body">
						...
						<div class="c-panel">							
						<div class="c-comments" style="font-size:13px;"><a href="#"><i class="icon-speech"></i> <?= $module_passe ?>/<?= $module_total ?> <?php if ($module_total > 1) {
																																																																																																																																								echo "Modules";
																																																																																																																																							} else {
																																																																																																																																								echo "Modules";
																																																																																																																																							} ?></a></div>
