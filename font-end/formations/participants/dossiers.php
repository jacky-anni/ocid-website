			    		 ...
			    		 <?php if ($module_passe == $module_total && $module_total >=1) : ?>
			    			<li>
			    				<div class="c-post">
			    					...
			    					<div class="c-date">
			    						<a download href="<?= $link_menu ?>/certificat/<?= $formation->id ?>/<?= Fonctions::user()->id ?> " target="_blank">  <span style="margin-right: 7px;" target="_blank"><b><i class="fa fa-download"></i> Télécharger</b></span></a> 
			    					</div>
			    				</div>
			    			</li>
			    		<?php endif ?> 
